...
export default function EditDutyInfoStaffForm() {
  ...
  const {user} = useAuth() 
  const { data } = useGetDutyInfo(user?.id ? parseInt(String(user?.id)) : 1);
...
useEffect(()=>{
 ...
 <div className="p-2 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg">              <Banknote className="w-3 h-3 text-white" />
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid md:grid-cols-2 gap-3">
                <div className="space-y-1 relative">
                  ...
                  <div className="relative w-full space-y-2 sm:w-1/2">
                    <textarea
