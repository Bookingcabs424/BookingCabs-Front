...
const ProfilePersonalSchema = z.object({
  ...
  dob: z.string().min(1, "Invalid DOB"),
      ...
      >
        <div className="flex justify-between">
              ...
              <div className="space-y-3">
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      {/* <div className="px-4 py-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 text-gray-700">
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      value={userProfile?.landline_number || ""}
                      className="border border-gray-300 p-2 px-3 outline-none rounded-sm w-full text-[10px] sm:text-[10px]"
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      value={userProfile?.alternate_mobile || ""}
                      className="border border-gray-300 p-2 px-3 outline-none rounded-sm w-full text-[10px] sm:text-[10px]"
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      value={userProfile?.external_ref || ""}
                      className="border border-gray-300 p-2 px-3 outline-none rounded-sm w-full text-[10px] sm:text-[10px]"
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    {/* {showSuggestions && cityData?.length > 0 && (
                      <ul className="border rounded bg-white shadow-md max-h-30 overflow-y-auto text-[10px] text-gray-800">
          ...
          {/* <div className="flex flex-col items-center space-y-3">
                ...
                <div className="text-center">
                  <p className="text-[10px]  text-gray-700">License Proof</p>
                  <p className="text-xs text-gray-500">
                    Click to upload or change
                  </p>
                </div>
          ...
          {/* <div className="flex flex-col items-center space-y-3">
                ...
                <div className="text-center">
                  <p className="text-[10px]  text-gray-700">Company Pan Card</p>
                  <p className="text-xs text-gray-500">
                    Click to upload or change
                  </p>
                </div>
          ...
          {/* <div className="flex flex-col items-center space-y-3">
                ...
                <div className="text-center">
                  <p className="text-[10px]  text-gray-700">Company Logo</p>
                  <p className="text-xs text-gray-500">
                    Click to upload or change
                  </p>
                </div>
