"use client";
import SingleCarDetail from "../../components/SingleCarDetail";
import { bookingFormData, bookingFormSchema } from "../../components/BookingForm";

import { Settings2, Star, X, ReceiptText, ListFilter } from "lucide-react";
...
const LocalVehiclesListPage = () => {
  ...
  const fetchVehicleData = async () => {
    try {
      const sortedVehicleTypes = [...form?.vehicle_type_list]
  ...
  const { data: packages } = useLocalPackages(3);
  useEffect(() => {}, [packages]);
      ...
      <Suspense fallback={<div>Loading...</div>}>
        <div className="flex items-center justify-center">
          <div className="py-6 relative w-[85%] lg:w-[85%] flex flex-col items-center justify-center">
            {/* Form */}
            <div className="w-full mt-6 px-5 vehicle-list-details py-4 shadow-md rounded-md">
              <div className="grid grid-cols-2 sm:grid-cols-2 items-start mx-auto place-items-center md:grid-cols-5 gap-5 xl:grid-cols-10">
                {form?.package && (
                  <div className="package flex flex-col gap-3 text-center">
                ...
                {form?.pickup_location && (
                  <div className="pickup-area flex flex-col gap-3 text-center col-span-1 md:col-span-2">
                ...
                <div className="pickup-address flex flex-col gap-3 text-center col-span-1 md:col-span-2">
                  <p className="font-[600] text-[#9d7a20] text-[12px]">
                    Pickup Address
                  </p>
                ...
                <div className="date flex flex-col gap-3 text-center">
                  <p className="font-[600] text-[#9d7a20] text-[12px]">Date</p>
                  <p className="text-[12px]">{form?.pickup_date}</p>
                </div>
                <div className="time flex flex-col gap-3 text-center">
            ...
            <div className="block relative w-full bg-[#dfad0a] py-2 px-4 rounded-md mt-10 flex items-center justify-between xl:justify-end xl:hidden">
              <button
                className="hidden sm:block xl:hidden bg-white px-5 py-2 rounded-md font-[500] cursor-pointer text-sm"
            ...
            cursor-pointer rounded-md px-2 focus:outline-none md:hidden text-[12px]"
                  >
                ...
                <button
                  className="bg-white rounded-full p-2 cursor-pointer block lg:hidden"
              ...
              {openPaymentDetails && (
                <div className="responsive-payment-div absolute right-[0px] top-full border border-gray-300 text-sm w-[250px] bg-white p-3 shadow-md rounded-md z-50 md:hidden">
            ...
            <div className="listing py-9 grid grid-cols-12 gap-3 w-full">
              ...
              <div className="vehicles-list w-full col-span-12 lg:col-span-9 xl:col-span-8">
                ...
                {packages?.data?.data?.length > 0 && (
                  <div className="package-list flex items-center gap-1 hidden md:flex md:my-3">
                    {packages?.data?.data?.map(({ name, id }: any) => {
                      const isSelected = selectedPackages.includes(id);
                      return (
                        <button
                          key={id}
                          onClick={() => onSelectPackage(id)}
                          className={`package border border-[#dfad0a] text-center rounded-full px-3 py-1 text-[12px] cursor-pointer ${
                            isSelected && "bg-[#dfad0a] font-[500]"
                          }`}
                        >
                          {name}
                        </button>
        ...
        >
          ...
          <div className="px-5">
            ...
            <div className="action-btns flex items-center justify-center gap-2 my-8 mb-6">
              <button
                title=""
                className="bg-[#dfad0a] rounded-full px-5 py-2 cursor-pointer font-[500] text-sm"
              >
                Apply
              </button>
              <button
                title=""
                className="border border-[#dfad0a] rounded-full px-5 py-2 cursor-pointer font-[500] text-sm"
              >
                Clear
              </button>
            </div>
...
export default LocalVehiclesListPage;
