          ...
          <>
            <div className="mb-4 relative">
              ...
              <input
                ...
                className="text-black password-input w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#9d7a20] focus:border-[#9d7a20] transition-all duration-200 text-[12px] sm:text-sm"
              />
              {errors.password && (
                <p className="text-red-500 text-sm mt-1">
              ...
              <button
                ...
                className="absolute right-[6px] cursor-pointer text-gray-500 top-[35px]"
              >
